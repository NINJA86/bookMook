              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="flex items-start gap-3 rounded-[24px] border border-border bg-background/50 p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Thoughtfully designed detail pages keep discovery immersive
                    and premium.
                  </p>
                </div>
                <div className="flex items-start gap-3 rounded-[24px] border border-border bg-background/50 p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Curated descriptions make each title feel editorial instead
                    of transactional.
                  </p>
                </div>
                <div className="flex items-start gap-3 rounded-[24px] border border-border bg-background/50 p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Local image assets render reliably without depending on
                    remote sources.
                  </p>
                </div>
                <div className="flex items-start gap-3 rounded-[24px] border border-border bg-background/50 p-4">
                  <Check className="mt-1 h-4 w-4 text-primary" />
                  <p className="text-sm text-muted-foreground">
                    Reader reviews and purchase controls stay integrated into
                    one clean flow.
                  </p>
                </div>
              </div>
